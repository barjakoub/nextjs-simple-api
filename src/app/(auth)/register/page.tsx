...
import ConfirmPassword from "@/units/forms/confirm-password";
                ...
                <div className="w-full max-w-xs border-gray-300">
                    <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        ...
                        <div className="flex items-center justify-between">
                            <button className="bg-blue-500 hover:bg-teal text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                                Sign Up
                            </button>
                            {/* <a className="" href="#">
                                Register
